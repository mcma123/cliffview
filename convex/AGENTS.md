...
- Public queries, all `requireAdmin` except `auth.viewer`: `modules.listForAdmin`, `modules.adminDetail`, `lessons.adminDetail`, `assets.adminDetail`, `dashboard.adminOverview`, `staff.directory`, `staff.detail`, `questions.adminList`
